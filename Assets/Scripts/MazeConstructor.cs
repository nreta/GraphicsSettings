...
public class MazeConstructor : MonoBehaviour
{
    ...
    TriggerEventHandler startCallback = null,
    TriggerEventHandler goalCallback = null)
    {
        if (sizeRows % 2 == 0 && sizeCols % 2 == 0)
        {
            UnityEngine.Debug.LogError("Odd numbers work better for dungeon size.");
        }
    ...
    // 👇 Add your OnGUI method right here — INSIDE the class, AFTER other methods
    void OnGUI()
    {
        // 1
        if (!showDebug)
